...
<form   name="myform" action="secondbb.php" method = "POST" onsubmit="return validate()">
<h1 align="center" style="color:orange;background:aqua;">SVCE-2019-MCA-2-B/S</h1>
...
<tr>
<td class="a">1.DataBase Management System [P.A.RAMESH]</td>
...
<tr>
<td class="a">2.Computer Networks [Dr.P.BABY MARUTHI]</td>
...
<tr>
<td class="a">3.Web Technologies [G.CHIDANANDA]</td>
...
<tr>
<td class="a">4.Software Engineering [V.VIJAYA CHANDRA RAO]</td>
...
<td class="a">5.Operating Systems [P.LOKESH KUMAR REDDY]</td>
