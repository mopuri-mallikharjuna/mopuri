...
<form   name="myform" action="thirdbb.php" method = "POST" onsubmit="return validate()">
<h1 align="center" style="color:orange;background:aqua;">SVCE-2019-MCA-3-B/S</h1>
...
<tr>
<td class="a">2.Software Testing [C.H.L.DHEERAJ]</td>
...
<tr>
<td class="a">4.Python Programming [K.HEMA]</td>
...
<td class="a">5.Software Project Management [S.NARASIMHULU]</td>
