...
<form   name="myform" action="secondaa.php" method = "POST" onsubmit="return validate()">
<h1 align="center" style="color:orange;background:aqua;">SVCE-2019-MCA-2-A/S</h1>
...
<tr>
<td class="a">2.Computer Networks [A.JYOTHSNA]</td>
...
<tr>
<td class="a">4.Software Engineering [P.RAVINDRA]</td>
...
<td class="a">5.Operating Systems [S.NARASIMHULU]</td>
