...
#main td.a{color:yellow;border:1px solid black;}
...
<form   name="myform" action="thirdaa.php" method = "POST" onsubmit="return validate()">
<h1 align="center" style="color:orange;background:aqua;">SVCE-2019-MCA-3-A/S</h1>
...
<tr>
<td class="a">1.Cloud Computing [V.DEEPIKA]</td>
...
<tr>
<td class="a">2.Software Testing [Dr.K.HIMABINDU]</td>
...
<tr>
<td class="a">3.Fundamentals Of Datascience [Dr.K.HEMALATHA]</td>
...
<tr>
<td class="a">4.Python Programming [Y.A.SIVAPRASAD]</td>
<td ><select name="sk4" id="d1" autofocus>
<option value=" "></option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
...
<td class="a">5.Software Project Management [P.LOKESH KUMAR REDDY]</td>
